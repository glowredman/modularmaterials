...
public enum Templates {
    MODEL_ITEM(
            ...
            "  \"textures\": {",
            "    \"layer0\": \"" + MM_Reference.MODID + ":item/%1$s/%2$s\",",
            "    \"layer1\": \"" + MM_Reference.MODID + ":item/%1$s/%2$s_overlay\"", "  }",
            "}"),
    ...
    MODEL_BLOCK(
            ...
            "  \"textures\": {",
            "    \"0\": \"" + MM_Reference.MODID + ":block/%1$s/%2$s\",",
            "    \"1\": \"" + MM_Reference.MODID + ":block/%1$s/%2$s_overlay\",",
            "    \"particle\": \"" + MM_Reference.MODID + ":block/%1$s/%2$s\"",
            "  },",
            "  \"elements\": [",
            "    {",
            "      \"from\": [0, 0, 0],",
    ...
    MODEL_ORE(
            ...
            "  \"textures\": {",
            "    \"0\": \"%2$s\",",
            "    \"1\": \"" + MM_Reference.MODID + ":block/%1$s/ore\",",
            "    \"particle\": \"%2$s\"",
            "  },",
            "  \"elements\": [",
            "    {",

...
public class MiscBlockFalling extends BlockFalling {
	
	public JMiscBlock block;
	
	public MiscBlockFalling(JMiscBlock block, String name) {
		super(MinecraftHelper.getMaterial(block.material));
		this.block = block;
